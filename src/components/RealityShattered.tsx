  ...
  return (
    <div className="absolute inset-0 z-50 flex flex-col items-center justify-center bg-transparent backdrop-blur-xl">
      ...
      <motion.div 
        ...
        className="text-center relative z-10 max-w-lg px-8"
      >
        ...
        <div className="flex flex-col gap-4">
          ...
          <button 
            ...
            className="w-full border border-gray-600 bg-transparent text-gray-400 py-4 font-bold uppercase text-sm tracking-widest hover:border-white hover:text-white transition-colors"
          >
            Return to Title
          </button>
        </div>
